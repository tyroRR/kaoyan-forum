...
const api = {
  ...
  reqUploadLessons: params => axios.post(`/admin/uploadLessons`, params),
  reqUpdateLesson: (id, params) => axios.patch(`/admin/updateLesson/${id}`, params),
  reqDeleteLesson: id => axios.delete(`/admin/deleteLesson/${id}`),
